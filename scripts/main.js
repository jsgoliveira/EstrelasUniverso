;(function (window) {
  ...
  let texts = ['CECILIA', 'VOCÊ É MAIS LINDA', 'DO QUE TODAS', 'AS ESTRELAS DO CÉU', 'MEU AMOR POR VOCÊ', 'É MAIOR', 'QUE A IMENSIDÃO', 'DO UNIVERSO', 'EU', 'TE', 'AMO', 'MUITO']
  ...
  function draw () {
    ...
    ctx.fillText(text, (canvas.width - ctx.measureText(text).width) * 0.5, canvas.height * 0.5)
  ...
  function setDimensions () {
    ...
    canvas.style.marginTop = '0px'; // Removed the marginTop setting
  }
